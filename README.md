...
flowchart LR
    ...
    Measurement["Measurement Service<br/>REST :8080"]
    Integration["Integration Service<br/>REST :8081"]
    Device["Device Service<br/>REST :8082"]
    Alarm["Alarm Service<br/>SOAP /ws :8083"]
...
The following graph shows the application-to-application calls between the deployed services.

```mermaid
flowchart TD
  Client[IoT producer or API client]
  Measurement["Measurement Service<br/>Azure App Service"]
  Integration["Integration Service<br/>Azure App Service"]
  Device["Device Service<br/>Azure App Service"]
  Alarm["Alarm Service<br/>Azure App Service /ws"]
...
**Azure App Service:** `https://iot-measurement-service-nadir-hfhndngzgsg6apdn.belgiumcentral-01.azurewebsites.net`

| Method | Local endpoint | Azure endpoint | Description |
| --- | --- | --- | --- |
| `POST` | `/api/measurements` | `/api/measurements` | Store and forward a measurement |
| `GET` | `/api/measurements` | `/api/measurements` | List measurements, newest first |
| `GET` | `/api/measurements/{measurementId}` | `/api/measurements/{measurementId}` | Retrieve one measurement by UUID |

**Full Azure POST endpoint:** `https://iot-measurement-service-nadir-hfhndngzgsg6apdn.belgiumcentral-01.azurewebsites.net/api/measurements`
...
**Azure App Service:** `https://device-service-tug-c7c5apg2f3aee5ak.belgiumcentral-01.azurewebsites.net`

| Method | Local endpoint | Azure endpoint | Description |
| --- | --- | --- | --- |
| `POST` | `/api/devices` | `/api/devices` | Register a device |
| `GET` | `/api/devices` | `/api/devices` | List all registered devices |
| `GET` | `/api/devices/{deviceId}` | `/api/devices/{deviceId}` | Retrieve a device by its external ID |

**Full Azure device lookup endpoint:** `https://device-service-tug-c7c5apg2f3aee5ak.belgiumcentral-01.azurewebsites.net/api/devices/{deviceId}`
...
**Azure App Service:** `https://integration-service-gcayewebb3hjffb0.belgiumcentral-01.azurewebsites.net`

| Method | Local endpoint | Azure endpoint | Description |
| --- | --- | --- | --- |
| `POST` | `/api/integration/measurements` | `/api/integration/measurements` | Validate the device and forward to Alarm Service |

**Full Azure integration endpoint:** `https://integration-service-gcayewebb3hjffb0.belgiumcentral-01.azurewebsites.net/api/integration/measurements`
...
**Azure App Service:** `https://alarm-service-nadir-fxh7awdshje6gmep.belgiumcentral-01.azurewebsites.net`

**Azure SOAP endpoint:** `https://alarm-service-nadir-fxh7awdshje6gmep.belgiumcentral-01.azurewebsites.net/ws`

Local WSDL: `http://localhost:8083/ws/alarm.wsdl`

**Azure WSDL:** `https://alarm-service-nadir-fxh7awdshje6gmep.belgiumcentral-01.azurewebsites.net/ws/alarm.wsdl`
...
For the current Azure deployment, use:

```text
INTEGRATION_SERVICE_URL=https://integration-service-gcayewebb3hjffb0.belgiumcentral-01.azurewebsites.net
DEVICE_SERVICE_URL=https://device-service-tug-c7c5apg2f3aee5ak.belgiumcentral-01.azurewebsites.net
ALARM_SERVICE_URL=https://alarm-service-nadir-fxh7awdshje6gmep.belgiumcentral-01.azurewebsites.net/ws
```
...
| Service | Azure App Service URL | Main endpoint | Used by |
| --- | --- | --- | --- |
| Measurement Service | `https://iot-measurement-service-nadir-hfhndngzgsg6apdn.belgiumcentral-01.azurewebsites.net` | `/api/measurements` | External producers and API clients |
| Integration Service | `https://integration-service-gcayewebb3hjffb0.belgiumcentral-01.azurewebsites.net` | `/api/integration/measurements` | Measurement Service via `INTEGRATION_SERVICE_URL` |
| Device Service | `https://device-service-tug-c7c5apg2f3aee5ak.belgiumcentral-01.azurewebsites.net` | `/api/devices` | Integration Service via `DEVICE_SERVICE_URL` |
| Alarm Service | `https://alarm-service-nadir-fxh7awdshje6gmep.belgiumcentral-01.azurewebsites.net` | `/ws` | Integration Service via `ALARM_SERVICE_URL` |
